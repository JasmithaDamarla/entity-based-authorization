...
//	@PreAuthorize("hasPermission('orgs','CREATE_PRIVILEGE')")
	@PostMapping
...
//	@PreAuthorize("hasPermission('orgs','READ_PRIVILEGE')")
	@GetMapping("/orgsName")
...
//	@PreAuthorize("hasPermission('orgs','UPDATE_PRIVILEGE')")
	@PutMapping
...
//	@PreAuthorize("hasPermission('orgs','DELETE_PRIVILEGE')")
	@DeleteMapping("/{id}")
